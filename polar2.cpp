...
void cartesian2polar(const double x, const double y)
{
	...
	// Die Funktion atan2 erwartet als Argumente die beiden Werte der kartesischen Koordinaten x und y (Reihenfolge: y,x) und liefert den arctan in Radian zurück.
}
